...
export class SaleFormComponent implements OnInit {
  ...
  validateForm(): void {
    ...
    this.validationFields.find((v) => v.name === 'people_id').validation =
      !!this.myForm.value.people_id;
    if (
      ...
      this.validationFields.find((v) => v.name === 'category_id').validation =
        !!this.myForm.value.category_id;

      this.searchBank.validation = !!this.myForm.value.bank_account_id;
      this.validationFields.find(
        (v) => v.name === 'bank_account_id'
      ).validation = !!this.myForm.value.bank_account_id;
    }
